...
public class TrafficLightTests {
    ...
    @Test
    @DisplayName("Does the light go from GREEN to YELLOW? --> NO")
    ...
    @Test
    @DisplayName("Does the light go from GREEN to YELLOW? --> YES")
    ...
    @Test
    @DisplayName("Does the light go from YELLOW to RED after GREEN? --> NO")
    ...
    @Test
    @DisplayName("Does the light go from YELLOW to RED after GREEN? --> YES")
    ...
    @Test
    @DisplayName("Does the light go from RED to YELLOW? --> YES")
    ...
    @Test
    @DisplayName("Does the light go from RED to YELLOW? --> NO ")
    ...
    @Test
    @DisplayName("Does the light go from YELLOW to GREEN after RED? --> NO")
    ...
    @Test
    @DisplayName("Does the light go from YELLOW to GREEN after RED? --> YES")
